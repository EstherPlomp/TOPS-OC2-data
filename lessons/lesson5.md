...
[//]: # This image is not rendering in the Jupyter notebook, however it renders in the Github, there appears to be a mismatch between this rendering we can't figure out
